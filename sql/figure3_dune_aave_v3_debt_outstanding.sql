with current_market_ as (
    ...
    FROM
        aave_v3_ethereum.Pool_evt_ReserveDataUpdated r
...
reserves as (
    SELECT
        ...
        t.decimals
    FROM
        aave_v3_ethereum.PoolConfigurator_evt_ReserveInitialized r
...
variableDebtChanges as (
    SELECT
        ...
        'mint' as type
    FROM
        aave_v3_ethereum.VariableDebtToken_evt_Mint m
    UNION
    ALL
    SELECT
        contract_address,
        ...
        'burn' as type
    FROM
        aave_v3_ethereum.VariableDebtToken_evt_Burn b
),
scaled_amts as (
    SELECT
        r.symbol,
